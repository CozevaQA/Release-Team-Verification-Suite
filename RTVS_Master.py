...
def master_gui():
    ...
    Button(root, text="First time Setup", command=on_first_time_setup, font=("Nunito Sans", 10)).grid(row=1,
                                                                                                      ...
                                                                                                      columnspan=4,
                                                                                                      sticky="w")
    Button(root, text="Verification Suite", command=on_verification_suite, font=("Nunito Sans", 10)).grid(row=2,
                                                                                                          column=1,
                                                                                                          columnspan=4,
                                                                                                          sticky="w")
    Button(root, text="HCC Validation Multi (Custom client list)", command=on_hcc_validation,
           font=("Nunito Sans", 10)).grid(row=3,
                                          column=1,
                                          columnspan=4,
                                          sticky="w")
    Button(root, text="Global Search", command=on_global_search, font=("Nunito Sans", 10)).grid(row=4,
                                                                                                ...
                                                                                                columnspan=4,
                                                                                                sticky="w")
    Button(root, text="Task Ingestion (AWV Only, Others WIP)", command=on_task_ingestion,
           font=("Nunito Sans", 10)).grid(row=5,
                                          column=1,
                                          columnspan=4,
                                          sticky="w")
    ...
    Button(root, text="Slow Log Trends", command=on_slow_trends, font=("Nunito Sans", 10)).grid(row=7,
                                                                                                ...
                                                                                                columnspan=4,
                                                                                                sticky="w")
    Button(root, text="Multi-role Access Check", command=on_role_access, font=("Nunito Sans", 10)).grid(row=8, column=1,
                                                                                                        columnspan=5,
                                                                                                        sticky="w")
    Button(root, text="Special Columns", command=on_special_columns, font=("Nunito Sans", 10)).grid(row=9,
                                                                                                    ...
                                                                                                    columnspan=4,
                                                                                                    sticky="w")
    Button(root, text="Hospital Activity (All Clients)", command=on_hospital_activity, font=("Nunito Sans", 10)).grid(
        row=10,
        column=1,
        columnspan=4,
        sticky="w")
